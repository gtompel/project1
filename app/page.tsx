        ...
        <section id="about" className="container py-12 md:py-24 space-y-8">
          <div className="flex flex-col items-center text-center space-y-4">
            ...
            <p className="text-muted-foreground md:text-xl max-w-[700px]">
              Мой код служит мостом между сегодняшним днём и завтрашними
              возможностями. Я глубоко убеждён в созидательную силу каждой строки
              кода, которая формирует новые впечатления.<br />
              Для меня непрерывный рост,
              гибкость и новаторство — это не просто аспекты работы, а философия
              жизни. Стремлюсь создавать эффективные решения, которые
              положительно влияют на эволюцию цифровой среды, делая её более
              доступной и полезной для всех.
            </p>
          </div>
        </section>
