...
export function StructuredData() {
  const personSchema = {
    ...
    description:
      'Опытный Full Stack разработчик с экспертизой в React, Next.js, Node.js, PostgreSQL и DevOps практиках',
    url: 'https://youchoice.vercel.app',
    sameAs: ['https://github.com/gtompel', 'mailto:quimpik@yandex.ru'],
    knowsAbout: [
      'React',
      'Next.js',
      'TypeScript',
  ...
  const resumeSchema = {
    ...
    education: {
      ...
      description:
        'Специальность связанная с информационными технологиями и системами безопасности',
    },
  };
